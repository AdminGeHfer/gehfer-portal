          ...
          <Auth
            ...
            appearance={{
              ...
              variables: {
                default: {
                  colors: {
                    ...
                    inputBackground: theme === 'dark' ? '#1a1b1e' : 'white',
                    inputText: theme === 'dark' ? '#ffffff' : '#1e293b',
                    inputPlaceholder: theme === 'dark' ? '#9ca3af' : '#64748b',
                    inputBorder: theme === 'dark' ? '#2d2d2d' : '#e2e8f0',
                    inputBorderHover: theme === 'dark' ? '#404040' : '#cbd5e1',
              ...
              className: {
                ...
                input: 'font-sans backdrop-blur-sm bg-white/50 dark:bg-zinc-800/50 border-gray-200/50 dark:border-zinc-700/50 focus:border-gray-400 dark:focus:border-[#233554] transition-all duration-300',
